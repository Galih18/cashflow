            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ url('/transaksi') }}"
                        class="float-right btn btn-sm btn-info">Kembali</a>
                </div>
                <div class="card-body">
                    <form action="{{ url('/transaksi/update/'.$transaksi->id) }}"
                        method="POST">
                        @csrf
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group">
                            ...
                            echo"selected='selected'";} ?> value="Pemasukan">Pemasukan </option>
                                <option <?php if($transaksi->jenis=="Pengeluaran"){
                                echo"selected='selected'";} ?> value="Pengeluaran">Pengeluaran </option>
                            </select>
                            @if($errors->has('jenis'))
                                <span class="text-danger">
